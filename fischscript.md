...
local trueData = "5ba4fb95dcee45e88fb118693171f22c"
local falseData = "779d0d65058148eab76d8eab9c3ff777"
...
local Checkkey = Tabs.KeySys:AddButton({
    ...
    Callback = function()
        ...
        if response == trueData then
           print("Key is valid")
           if getgenv().hub then warn("Modyolo Hub : Executado!") return end
getgenv().hub = true
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Modyolo Hub - Premium",
    SubTitle = " (https://discord.gg/DJMtqY6s6m)", -- discord link
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Callback = function()
            setclipboard("https://discord.gg/DJMtqY6s6m") -- discord link
        end
    })
